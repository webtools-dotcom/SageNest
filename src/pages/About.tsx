...
export const AboutPage = () => {
  return (
    <main id="main-content" className="container article">
      ...
      <p>
        SageNest articles are researched and written by the <strong>SageNest Editorial Team</strong> —
        a dedicated team focused on sourcing accurate, up-to-date pregnancy and women's health
        information from the most established clinical authorities in the field.
      </p>
      <p>
        Every article on SageNest draws directly from guidelines and research published by:
      </p>
      <ul>
        <li><strong>ACOG</strong> — American College of Obstetricians and Gynecologists</li>
        ...
        <li><strong>IOM</strong> — Institute of Medicine (National Academies)</li>
      </ul>
      <p>
        We do not publish personal opinions, anecdotal advice, or information sourced from
        unverified platforms. Every clinical claim in a SageNest article aims to reflect current
        evidence from the above institutions.
      </p>
      <p>
        Each article also includes a dedicated <strong>"When to Call Your Doctor"</strong> section
        with specific, observable red flags — because we believe health content should always direct
      ...
      <p>
        Every calculation method and piece of educational content on SageNest aims to reflect
        established medical standards and clinical guidelines. Our due date formulas align with
        those used by healthcare providers, including:
      </p>
      <ul>
