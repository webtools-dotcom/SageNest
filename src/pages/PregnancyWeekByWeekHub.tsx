...
const HUB_STYLES = `
  ...
  .pwb-scroll-line {
    width: 1px;
    height: 48px;
    background: linear-gradient(to bottom, rgba(253,248,241,0.35), transparent);
...
// Milestone weeks that get the wide dark card
...
export default function PregnancyWeekByWeekHub() {
  ...
  const scrollToContent = () => {
    document.querySelector(".pwb-trimester-section")?.scrollIntoView({ behavior: "smooth" });
  };
  ...
  return (
    <div className="pwb-hub">
      ...
      <section className="pwb-hero" aria-label="Pregnancy week by week guide">
        ...
        <button
          className="pwb-hero-scroll"
          onClick={scrollToContent}
          aria-label="Scroll to weeks"
        >
          <span>Begin</span>
          <div className="pwb-scroll-line" />
        </button>
      </section>
